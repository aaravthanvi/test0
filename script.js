...
const translations = {
    en: {
        ...
        'cat-dream': 'Dreams',
        'cat-peace': 'Peace',
            'cat-gita': 'Bhagavad Gita',
    'cat-stoicism': 'Stoicism',
        back: 'Back',
        'new-quote': 'Next',
        share: 'Share',
        voice: 'Listen',
...
const categoryKeywords = {
    ...
    'peace': ['peace', 'calm', 'quiet', 'tranquil', 'serene', 'still', 'silence', 'rest', 'harmony', 'balance', 'ease', 'gentle', 'soothe', 'relax'],
     'gita': ['gita', 'bhagavad', 'krishna', 'dharma', 'arjuna', 'karma', 'yoga', 'verse', 'bhagvan', 'sacred', 'divine', 'soul', 'spirit', 'duty', 'enlightenment', 'wisdom', 'eternal', 'truth'],
...
const curatedQuotes = [
 ...
 // Bhagavad Gita (100+ Inspirational Verses from Krishna)
 { id: 10100, quote: "Yoga is the journey of the self, through the self, to the self.", author: "Lord Krishna" },
 { id: 10101, quote: "You have the right to work, but for the work's sake only. You have no right to the fruits of work.", author: "Lord Krishna" },
 { id: 10102, quote: "It is better to live your own destiny imperfectly than to live an imitation of somebody else's life with perfection.", author: "Lord Krishna" },
 { id: 10103, quote: "The greatest religion is to be true to this dharma; neglect of it has caused the ruin of many.", author: "Lord Krishna" },
 { id: 10104, quote: "No one can escape from his own nature.", author: "Lord Krishna" },
 { id: 10105, quote: "The self is never born, and nor does it ever die.", author: "Lord Krishna" },
 { id: 10106, quote: "Man is made by his belief. As he believes, so he is.", author: "Lord Krishna" },
 { id: 10107, quote: "The greatest wealth is health.", author: "Lord Krishna" },
 { id: 10108, quote: "Perform your obligatory duty, because action is indeed better than inaction.", author: "Lord Krishna" },
 { id: 10109, quote: "It is impossible for a man to be deprived of his natural duty.", author: "Lord Krishna" },
 { id: 10110, quote: "Knowledge is the ultimate purifier.", author: "Lord Krishna" },
 { id: 10111, quote: "The embodied soul is eternal, immutable, and primeval. He is not destroyed when the body is destroyed.", author: "Lord Krishna" },
 { id: 10112, quote: "Better than silence is truth-speaking; better than truth-speaking is gentle truth-speaking.", author: "Lord Krishna" },
 { id: 10113, quote: "Even if you consider yourself the greatest sinner, all sins can be redeemed by sincere devotion.", author: "Lord Krishna" },
 { id: 10114, quote: "The greatest charity is that given when one is in need oneself.", author: "Lord Krishna" },
 { id: 10115, quote: "All that we are is the result of what we have thought. The mind is everything. What we think we become.", author: "Lord Krishna" },
 { id: 10116, quote: "Arjuna, the wise grieve neither for the living nor for the dead.", author: "Lord Krishna" },
 { id: 10117, quote: "It is said the senses are superior to the body; superior to the senses is the mind. Beyond the mind is the intellect.", author: "Lord Krishna" },
 { id: 10118, quote: "Concentrate your mind on Me, become My devotee, offer your homage unto Me, and engage in My service.", author: "Lord Krishna" },
 { id: 10119, quote: "Among all kinds of killers, he who kills the self is the worst.", author: "Lord Krishna" },
 { id: 10120, quote: "The person who sees all creatures as spiritual entities deserves salvation.", author: "Lord Krishna" },
 { id: 10121, quote: "Discipline the senses and the mind through practice and detachment.", author: "Lord Krishna" },
 { id: 10122, quote: "As the embodied soul sheds worn out garments and wears new ones, similarly, at the time of death the soul casts off its worn out body and attains a new one.", author: "Lord Krishna" },
 { id: 10123, quote: "The ignorant work for their own profit, the wise work for the welfare of all humanity.", author: "Lord Krishna" },
 { id: 10124, quote: "Weapons cannot pierce it, fire cannot burn it, water cannot drench it, wind cannot dry it.", author: "Lord Krishna" },
 { id: 10125, quote: "This individual soul is unbreakable and insoluble, and can be neither burned nor dried.", author: "Lord Krishna" },
 { id: 10126, quote: "Calmness, gentleness, silence, self-restraint, and purity: these are called the discipline of the body.", author: "Lord Krishna" },
 { id: 10127, quote: "Those who are free from anger and all material desires, who are self-realized, and who are constantly engaged in meditation attain supreme peace.", author: "Lord Krishna" },
 { id: 10128, quote: "None can escape from his own nature, not even the mighty.", author: "Lord Krishna" },
 { id: 10129, quote: "The greatest secret is that we are not separate from the Eternal.", author: "Lord Krishna" },
 { id: 10130, quote: "Fix your mind on Me, direct your intention toward Me, and live in Me alone from now on.", author: "Lord Krishna" },
 { id: 10131, quote: "The mind is restless and difficult to restrain, but it is subdued by practice.", author: "Lord Krishna" },
 { id: 10132, quote: "Pleasures conceived in the world of the senses have a beginning and an end, and so the wise do not rejoice in them.", author: "Lord Krishna" },
 { id: 10133, quote: "He who conquers his passions has conquered the world.", author: "Lord Krishna" },
 { id: 10134, quote: "The person who is equal-minded amid the chaos of the world has attained yoga.", author: "Lord Krishna" },
 { id: 10135, quote: "In this world, there is nothing so sublime and pure as transcendental knowledge.", author: "Lord Krishna" },
 { id: 10136, quote: "One who is not disturbed by the incessant flow of desires has attained peace.", author: "Lord Krishna" },
 { id: 10137, quote: "The greatest victory is won over one's own self.", author: "Lord Krishna" },
 { id: 10138, quote: "Whatever action a man performs, whether right or wrong, he will reap the fruits thereof.", author: "Lord Krishna" },
 { id: 10139, quote: "Seek refuge in the attitude of surrender. Only by this can you gain supreme peace.", author: "Lord Krishna" },
 { id: 10140, quote: "Devotion is the ultimate purifier.", author: "Lord Krishna" },
 { id: 10141, quote: "Through yoga, the self becomes visible to one's own self.", author: "Lord Krishna" },
 { id: 10142, quote: "One must elevate oneself by one's own mind, not degrade oneself.", author: "Lord Krishna" },
 { id: 10143, quote: "The Eternal is the only true reality; all else is illusion.", author: "Lord Krishna" },
 { id: 10144, quote: "When you perform work, you are released from sin.", author: "Lord Krishna" },
 { id: 10145, quote: "The supreme truth is eternal, immutable, and beyond the reach of the mind.", author: "Lord Krishna" },
 { id: 10146, quote: "Violence done in ignorance is different from violence done knowingly.", author: "Lord Krishna" },
 { id: 10147, quote: "The person who acts without attachment, surrendering all actions to Me, is not bound by karmic reactions.", author: "Lord Krishna" },
 { id: 10148, quote: "With mind, body and soul aligned with the Eternal, one achieves liberation.", author: "Lord Krishna" },
 { id: 10149, quote: "To study the scriptures without attempting to practice their teachings is fruitless.", author: "Lord Krishna" },
 { id: 10150, quote: "The greatest wisdom is to know oneself as eternal and imperishable.", author: "Lord Krishna" },
 { id: 10151, quote: "A person is said to be well situated when he is steady in all circumstances.", author: "Lord Krishna" },
 { id: 10152, quote: "The supreme knowledge transcends all material knowledge.", author: "Lord Krishna" },
 { id: 10153, quote: "One should concentrate the mind on the Supreme by engaging the intellect.", author: "Lord Krishna" },
 { id: 10154, quote: "The soul is neither born, and nor does it die; all is eternal.", author: "Lord Krishna" },
 { id: 10155, quote: "The path of virtue is steep and difficult, yet rewarding.", author: "Lord Krishna" },
 { id: 10156, quote: "One must perform one's duty without attachment to the results.", author: "Lord Krishna" },
 { id: 10157, quote: "Through constant practice and detachment, the mind becomes purified.", author: "Lord Krishna" },
 { id: 10158, quote: "The greatest achievement is liberation from the cycle of birth and death.", author: "Lord Krishna" },
 { id: 10159, quote: "All beings are but manifestations of the Eternal.", author: "Lord Krishna" },
 { id: 10160, quote: "The wise understand the nature of brahman, the eternal reality.", author: "Lord Krishna" },
 { id: 10161, quote: "Only through renunciation of all worldly attachments can one attain eternal peace.", author: "Lord Krishna" },
 { id: 10162, quote: "Knowledge is the sword that cuts through the knot of ignorance.", author: "Lord Krishna" },
 { id: 10163, quote: "The person who sees inaction in action and action in inaction is the true yogi.", author: "Lord Krishna" },
 { id: 10164, quote: "Transform yourself through steady practice and meditation.", author: "Lord Krishna" },
 { id: 10165, quote: "The goal of all spiritual practice is union with the Divine.", author: "Lord Krishna" },
 { id: 10166, quote: "Just as the blazing fire reduces wood to ash, knowledge burns all karmic reactions.", author: "Lord Krishna" },
 { id: 10167, quote: "The divine dwells within all beings; recognize the God in everyone.", author: "Lord Krishna" },
 { id: 10168, quote: "Those who surrender completely to the Divine achieve ultimate freedom.", author: "Lord Krishna" },
 { id: 10169, quote: "Reality is one; sages describe it by many different names.", author: "Lord Krishna" },
 { id: 10170, quote: "The body is temporary; the soul is eternal and unchanging.", author: "Lord Krishna" },
 { id: 10171, quote: "Attachment to the fruits of action binds one to the cycle of birth and death.", author: "Lord Krishna" },
 { id: 10172, quote: "Act with complete dedication but without concern for the outcome.", author: "Lord Krishna" },
 { id: 10173, quote: "The wise are not affected by dualities like praise and blame.", author: "Lord Krishna" },
 { id: 10174, quote: "Through sincere devotion and service, one attains the highest knowledge.", author: "Lord Krishna" },
 { id: 10175, quote: "The greatest secret is that each soul carries the spark of the Divine.", author: "Lord Krishna" },
 { id: 10176, quote: "One should perform their prescribed duties without selfish desires.", author: "Lord Krishna" },
 { id: 10177, quote: "The mind is the source of both bondage and liberation.", author: "Lord Krishna" },
 { id: 10178, quote: "Those who practice meditation and control their senses achieve inner peace.", author: "Lord Krishna" },
 { id: 10179, quote: "The fruit of righteous action is eternal happiness and contentment.", author: "Lord Krishna" },
 { id: 10180, quote: "The soul is neither created nor destroyed; it is eternal and immutable.", author: "Lord Krishna" },
 { id: 10181, quote: "One who understands the nature of dharma and follows it attains liberation.", author: "Lord Krishna" },
 { id: 10182, quote: "The wise do not mourn over the living or the dead.", author: "Lord Krishna" },
 { id: 10183, quote: "Through steady practice and detachment, one transcends the lower nature.", author: "Lord Krishna" },
 { id: 10184, quote: "Surrender your ego, and you will find peace.", author: "Lord Krishna" },
 { id: 10185, quote: "The path to enlightenment is within; seek it not in external sources.", author: "Lord Krishna" },
 { id: 10186, quote: "One who acts without ego and selfishness is always at peace.", author: "Lord Krishna" },
 { id: 10187, quote: "The greatest love is the love of the Divine.", author: "Lord Krishna" },
 { id: 10188, quote: "All experiences are but lessons on the path to enlightenment.", author: "Lord Krishna" },
 { id: 10189, quote: "The truly wealthy are those who are content and spiritually rich.", author: "Lord Krishna" },
 { id: 10190, quote: "Through understanding your true nature, you attain immortality.", author: "Lord Krishna" },
 { id: 10191, quote: "Action performed with dedication and without attachment is the highest.", author: "Lord Krishna" },
 { id: 10192, quote: "The mind that is free from desires finds eternal peace.", author: "Lord Krishna" },
 { id: 10193, quote: "Those who serve humanity serve the Divine.", author: "Lord Krishna" },
 { id: 10194, quote: "The greatest teacher is experience; learn from all that life presents.", author: "Lord Krishna" },
 { id: 10195, quote: "Freedom is found not in running away, but in facing the truth.", author: "Lord Krishna" },
