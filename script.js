...
// ===== FORCE PHILOSOPHY BUTTON CLICKS TO WORK =====
console.log('Setting up philosophy buttons...');

// Wait for page to be ready
if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', setupPhilosophyButtons);
} else {
    setupPhilosophyButtons();
}

function setupPhilosophyButtons() {
    console.log('Philosophy button setup running...');
    
    const buttons = document.querySelectorAll('.philosophy-btn');
    console.log('Found', buttons.length, 'philosophy buttons');
    
    buttons.forEach((btn, index) => {
        const philosophy = btn.getAttribute('data-philosophy');
        console.log(`Button ${index}: ${philosophy}`);
        
        // Remove any existing listeners first
        btn.replaceWith(btn.cloneNode(true));
        
        // Get the new button
        const newBtn = document.querySelectorAll('.philosophy-btn')[index];
        
        // Add click listener
        newBtn.addEventListener('click', function(e) {
            e.preventDefault();
            console.log('Philosophy button clicked:', philosophy);
            ...
            if (philSection) {
                philSection.classList.add('hidden');
            }
        ...
        console.log(`Listener attached to ${philosophy} button`);
    });
}

// THIS IS THE END OF YOUR FILE - Nothing after this!
